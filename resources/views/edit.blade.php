            ...
            <div>
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="{{url('manageItem/'.$barang->id)}}" method="post">
                            @method('patch')
                            @csrf
                            <div class="form-group">
                                <label> Item Code</label>
                                <input type="text" name="code" class="form-control" value="{{$barang ->kode_barang}}" required>
                            </div>
                            <div class="form-group">
                                <label> Item Name</label>
                                <input type="text" name="name" class="form-control" value="{{$barang ->nama_barang}}" autofocus required>
                            </div>
                            <div>
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input type="text" name="price" class="form-control" value="{{$barang ->harga}}" required>
                            </div>
                            <div class="form-group">
